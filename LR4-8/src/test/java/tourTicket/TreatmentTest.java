...
class TreatmentTest {
    @Test
    void createCopyReturnsCopy() {
        Vacation vacation = TicketExemplars.ticketExemplars.get("TreatmentTwoWeeksKarpaty").createCopy();
        Assertions.assertEquals(TicketExemplars.ticketExemplars.get("TreatmentTwoWeeksKarpaty").getIdentificator(), vacation.getIdentificator());
    }
    @Test
    void getfullInfo() {
        Vacation vacation = TicketExemplars.ticketExemplars.get("TreatmentTwoWeeksKarpaty").createCopy();
